package com.project.charforge.model.entity.item;
...
public class Item extends BaseEntity implements StatModifier {
    ...
    public Item(int id, String name, double weight, EquipmentSlot validSlot, int strength, int dexterity, int intelligence, String iconPath) {
        super(id, name);
        this.weight = weight;
